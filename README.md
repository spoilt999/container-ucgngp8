...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ucgngp8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ucgngp8.containers.anotherwebservice.com/
...
```
git clone git@github.com:spoilt999/container-ucgngp8.git
cd container-ucgngp8
```
...
```
docker attach container-ucgngp8
```
